        ...
        <div className="overflow-y-auto px-6 py-8" style={{ height: 'calc(100% - 110px)' }}>
          ...
          {tab === 'neuro' && (
            <div className="space-y-10">
              ...
              {[
                { num: '02', code: 'D', name: 'ドーパミン', desc: '新規性・可能性', color: '#f87171',
                ...
                { num: '03', code: 'S', name: 'セロトニン', desc: '理解・秩序', color: '#60a5fa',
                ...
                { num: '04', code: 'O', name: 'オキシトシン', desc: '共感・接続', color: '#4ade80',
                ...
                { num: '05', code: 'N', name: 'ノルアドレナリン', desc: '緊張・集中', color: '#facc15',
                ...
                { num: '06', code: 'E', name: 'エンドルフィン', desc: '快感・没入', color: '#c084fc',
